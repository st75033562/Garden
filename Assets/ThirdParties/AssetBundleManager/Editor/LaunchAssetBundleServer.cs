...
namespace AssetBundles
{
    internal class LaunchAssetBundleServer : ScriptableSingleton<LaunchAssetBundleServer>
    {
        ...
        public static void ToggleLocalAssetBundleServer()
        {
            ...
            AssetBundleManager.LocalAssetBundleServer = IsRunning();
        }
        ...
        static void Run()
        {
            string pathToAssetServer = Path.GetFullPath("Assets/ThirdParties/AssetBundleManager/Editor/AssetBundleServer.exe");
