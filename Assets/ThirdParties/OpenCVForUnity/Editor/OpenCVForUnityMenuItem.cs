...
namespace OpenCVForUnity
{
        class OpenCVForUnityMenuItem : MonoBehaviour
        {
                ...
                {
                        //Android
                        SetPlugins (GetPluginFilePaths ("Assets/ThirdParties/OpenCVForUnity/Plugins/Android/libs/armeabi-v7a"), null,
new Dictionary<BuildTarget, Dictionary<string, string>> (){{BuildTarget.Android,new Dictionary<string, string> ()
                {{"CPU", "ARMv7"}
                }}});
                        SetPlugins (GetPluginFilePaths ("Assets/ThirdParties/OpenCVForUnity/Plugins/Android/libs/x86"), null,
           new Dictionary<BuildTarget, Dictionary<string, string>> (){{BuildTarget.Android,new Dictionary<string, string> ()
                {{"CPU", "x86"}
                }}});
                        ...
                        //iOS
                        SetPlugins (new string[] { "Assets/ThirdParties/OpenCVForUnity/Plugins/iOS/opencv2.framework" }, null,
new Dictionary<BuildTarget, Dictionary<string, string>> () { { BuildTarget.iOS, null } });
                        SetPlugins (GetPluginFilePaths ("Assets/ThirdParties/OpenCVForUnity/Plugins/iOS"), null,
                         new Dictionary<BuildTarget, Dictionary<string, string>> () { { BuildTarget.iOS, null } });


                        //OSX
                        SetPlugins (new string[] { "Assets/ThirdParties/OpenCVForUnity/Plugins/opencvforunity.bundle" }, new Dictionary<string, string> () { { "CPU", "AnyCPU" }, { "OS", "OSX" } },
new Dictionary<BuildTarget, Dictionary<string, string>> (){{BuildTarget.StandaloneOSXIntel,new Dictionary<string, string> ()
                ...
                {{"CPU", "AnyCPU"}
                        ...
                        //Windows
                        SetPlugins (new string[] { "Assets/ThirdParties/OpenCVForUnity/Plugins/x86/opencvforunity.dll" }, new Dictionary<string, string> () { { "CPU", "x86" }, { "OS", "Windows" } },
                   new Dictionary<BuildTarget, Dictionary<string, string>> (){{BuildTarget.StandaloneWindows,new Dictionary<string, string> ()
                        {{"CPU", "x86"}
                }}});

                        SetPlugins (new string[] { "Assets/ThirdParties/OpenCVForUnity/Plugins/x86_64/opencvforunity.dll" }, new Dictionary<string, string> () { { "CPU", "x86_64" }, { "OS", "Windows" } },
        new Dictionary<BuildTarget, Dictionary<string, string>> (){{BuildTarget.StandaloneWindows64,new Dictionary<string, string> ()
                {{"CPU", "x86_64"}
                        ...
                        //Linux
                        SetPlugins (new string[] { "Assets/ThirdParties/OpenCVForUnity/Plugins/x86/libopencvforunity.so" }, new Dictionary<string, string> () { { "CPU", "x86" }, { "OS", "Linux" } },
        new Dictionary<BuildTarget, Dictionary<string, string>> (){{BuildTarget.StandaloneLinux,new Dictionary<string, string> ()
                {{"CPU", "x86"}
                }},});

                        SetPlugins (new string[] { "Assets/ThirdParties/OpenCVForUnity/Plugins/x86_64/libopencvforunity.so" }, new Dictionary<string, string> () { { "CPU", "x86_64" }, { "OS", "Linux" } },
        new Dictionary<BuildTarget, Dictionary<string, string>> (){{BuildTarget.StandaloneLinux64,new Dictionary<string, string> ()
                {{"CPU", "x86_64"}
                        ...
                        //WSA
                        SetPlugins (GetPluginFilePaths ("Assets/ThirdParties/OpenCVForUnity/Plugins/WSA/SDK81/ARM"), null,
                         new Dictionary<BuildTarget, Dictionary<string, string>> (){{BuildTarget.WSAPlayer,new Dictionary<string, string> ()
                {{"SDK", "SDK81"},{"CPU", "ARM"}
                }}});
                        SetPlugins (GetPluginFilePaths ("Assets/ThirdParties/OpenCVForUnity/Plugins/WSA/SDK81/x64"), null,
new Dictionary<BuildTarget, Dictionary<string, string>> (){{BuildTarget.WSAPlayer,new Dictionary<string, string> ()
                {{"SDK", "SDK81"},{"CPU", "x64"}
                }}});
                        SetPlugins (GetPluginFilePaths ("Assets/ThirdParties/OpenCVForUnity/Plugins/WSA/SDK81/x86"), null,
                         new Dictionary<BuildTarget, Dictionary<string, string>> (){{BuildTarget.WSAPlayer,new Dictionary<string, string> ()
                {{"SDK", "SDK81"},{"CPU", "x86"}
                }}});

                        SetPlugins (GetPluginFilePaths ("Assets/ThirdParties/OpenCVForUnity/Plugins/WSA/PhoneSDK81/ARM"), null,
new Dictionary<BuildTarget, Dictionary<string, string>> (){{BuildTarget.WSAPlayer,new Dictionary<string, string> ()
                {{"SDK", "PhoneSDK81"},{"CPU", "ARM"}
                }}});
                        SetPlugins (GetPluginFilePaths ("Assets/ThirdParties/OpenCVForUnity/Plugins/WSA/PhoneSDK81/x86"), null,
                         new Dictionary<BuildTarget, Dictionary<string, string>> (){{BuildTarget.WSAPlayer,new Dictionary<string, string> ()
...
//        SetPlugins(GetPluginFilePaths("Assets/ThirdParties/OpenCVForUnity/Plugins/WSA/UWP/ARM"), null, null);
//        SetPlugins(GetPluginFilePaths("Assets/ThirdParties/OpenCVForUnity/Plugins/WSA/UWP/x64"), null, null);
//        SetPlugins(GetPluginFilePaths("Assets/ThirdParties/OpenCVForUnity/Plugins/WSA/UWP/x86"), null, null);
//#else
//        SetPlugins(GetPluginFilePaths("Assets/ThirdParties/OpenCVForUnity/Plugins/WSA/UWP/ARM"), null,
//                         new Dictionary<BuildTarget, Dictionary<string, string>>(){{BuildTarget.WSAPlayer,new Dictionary<string, string> ()
//                {{"SDK", "UWP"},{"CPU", "ARM"}
//                }}});
//        SetPlugins(GetPluginFilePaths("Assets/ThirdParties/OpenCVForUnity/Plugins/WSA/UWP/x64"), null,
//new Dictionary<BuildTarget, Dictionary<string, string>>(){{BuildTarget.WSAPlayer,new Dictionary<string, string> ()
//                {{"SDK", "UWP"},{"CPU", "x64"}
//                }}});
//        SetPlugins(GetPluginFilePaths("Assets/ThirdParties/OpenCVForUnity/Plugins/WSA/UWP/x86"), null,
//                         new Dictionary<BuildTarget, Dictionary<string, string>>(){{BuildTarget.WSAPlayer,new Dictionary<string, string> ()
//                {{"SDK", "UWP"},{"CPU", "x86"}
//                }}});
//#endif
