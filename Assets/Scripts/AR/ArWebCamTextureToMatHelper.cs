...
public class ArWebCamTextureToMatHelper : MonoBehaviour {
    ...
    private void init()
    {
        ...
        if (webCamTexture == null)
        {
            ...
            {
                webCamTexture = new WebCamTexture(requestWidth, requestHeight, requestFps);
            }
        }
        ...
        StartCoroutine(initWhenWebCamReady());
    }

    private IEnumerator initWhenWebCamReady()
    {
        while (true)
        {
    ...
    public Mat GetMat()
    {
        ...
        if (webCamDevice.isFrontFacing && Application.isMobilePlatform)
        {
