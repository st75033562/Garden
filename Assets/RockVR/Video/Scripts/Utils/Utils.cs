...
namespace RockVR.Video
{
    public class StringUtils
    {
        ...
        public static string GetRandomMp4FileName(int randomLength = 5)
        {
            return GetMp4FileName(GetRandomString(randomLength));
        }

        public static string GetRandomWavFileName(int randomLength = 5)
        {
            return GetWavFileName(StringUtils.GetRandomString(randomLength));
        }
