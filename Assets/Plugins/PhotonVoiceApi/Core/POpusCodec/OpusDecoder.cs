...
#pragma warning restore 414
        ...
        {
            return DecodePacketFloat(packetData, packetData != null ? packetData.Length : 0);
        }

        // pass null to indicate packet loss
        public float[] DecodePacketFloat(byte[] packetData, int length)
        {
            ...
            numSamplesDecoded = Wrapper.opus_decode(_handle, packetData, length, buf, 0, _channelCount);
